    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_number', models.CharField(max_length=20, validators=[django.core.validators.RegexValidator(message="Telefon raqam +998XXXXXXXXX yoki 998XXXXXXXXX formatida bo'lishi kerak.", regex='^(\\+998|998)?[0-9]{9}$')])),
